    ...
    public string ENABLE_NOTIFICATION_SERVICE { get; }
        ...
        public Config()
        {
            ...
            STORAGE_DIRECTORY = Environment.GetEnvironmentVariable("STORAGE_DIRECTORY") ?? string.Empty;
                // Azure Object Storage (when FILE_STORAGE_METHOD=azure_object)
            AZURE_OBJECT_CONNECTION_STRING = Environment.GetEnvironmentVariable("AZURE_OBJECT_CONNECTION_STRING") ?? string.Empty;
                // AWS S3 Storage (when FILE_STORAGE_METHOD=aws_s3)
            ...
            // Local Development
            DISABLE_BACKEND_AUTHENTICATION = Environment.GetEnvironmentVariable("DISABLE_BACKEND_AUTHENTICATION") ?? "false";
