...
{
    /// <inheritdoc />
    public partial class ArchiveProceduresLastUpdatedBy : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                CREATE OR REPLACE PROCEDURE deeplynx.unarchive_project(
                    arc_project_id INTEGER, 
                    arc_time TIMESTAMP WITHOUT TIME ZONE,
                    arc_by INTEGER
                )
            ...
            migrationBuilder.Sql(@"
                CREATE OR REPLACE PROCEDURE deeplynx.archive_class(
                    arc_class_id INTEGER,
                    arc_time TIMESTAMP WITHOUT TIME ZONE,
                    arc_by INTEGER
                )
                LANGUAGE plpgsql AS $$
            ...
            migrationBuilder.Sql(@"
                CREATE OR REPLACE PROCEDURE deeplynx.unarchive_class(
                    arc_class_id INTEGER, 
                    arc_time TIMESTAMP WITHOUT TIME ZONE,
                    arc_by INTEGER
                )
            ...
            migrationBuilder.Sql(@"
                CREATE OR REPLACE PROCEDURE deeplynx.unarchive_record(
                    arc_record_id INTEGER, 
                    arc_time TIMESTAMP WITHOUT TIME ZONE,
                    arc_by INTEGER
                )
