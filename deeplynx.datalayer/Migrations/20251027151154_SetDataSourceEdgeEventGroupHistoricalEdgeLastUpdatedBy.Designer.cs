...
namespace deeplynx.datalayer.Migrations
{
    ...
    [Migration("20251027151154_SetDataSourceEdgeEventGroupHistoricalEdgeLastUpdatedBy")]
    partial class SetDataSourceEdgeEventGroupHistoricalEdgeLastUpdatedBy
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("deeplynx.datalayer.Models.Event", b =>
                {
                    ...
                    b.HasIndex(new[] { "DataSourceId" }, "idx_events_data_source_id");

                    b.HasIndex(new[] { "Id" }, "idx_events_id");

                    b.HasIndex(new[] { "OrganizationId" }, "idx_events_organization_id");
            ...
            modelBuilder.Entity("deeplynx.datalayer.Models.Permission", b =>
                {
                    ...
                    b.HasIndex(new[] { "OrganizationId" }, "idx_permissions_organization_id");

                    b.HasIndex(new[] { "ProjectId" }, "idx_permissions_project_id");
            ...
            modelBuilder.Entity("deeplynx.datalayer.Models.HistoricalEdge", b =>
                {
                    ...
                    b.HasOne("deeplynx.datalayer.Models.User", "LastUpdatedByUser")
                        .WithMany("UpdatedHistoricalEdges")
                        .HasForeignKey("LastUpdatedBy")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("deeplynx.datalayer.Models.User", b =>
                {
                    ...
                    b.Navigation("UpdatedDataSources");

                    b.Navigation("UpdatedEdges");
