...
INSERT INTO historical_records (properties, data_source_id, data_source_name, project_name, class_name, original_id, name, tags, project_id) VALUES
('{"name": "series", "genre": "country", "year": 1997}'::jsonb, 6, 6, 2, 'musician', 1, 'series', '["{tag1}"]', 1),
('{"name": "possible", "genre": "pop", "year": 1984}'::jsonb, 6, 6, 2, 'song', 2, 'possible', '["{tag1}"]', 1);
