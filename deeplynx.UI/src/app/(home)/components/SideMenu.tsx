...
//   const [isProjectSettingsExpanded, setIsProjectSettingsExpanded] = useState<boolean>(false);
//   const [isMemberManagementExpanded, setIsMemberManagementExpanded] = useState<boolean>(false);
...
//                     onClick={(e) => handleItemClick("/project_settings/roles", e)}
...
const SideMenu: React.FC<SideMenuProps> = ({ onToggle }) => {
  ...
  const [isCollapsed, setIsCollapsed] = useState<boolean>(false);
  const [isProjectSettingsExpanded, setIsProjectSettingsExpanded] = useState<boolean>(false);
  const [isRoleSettingsExpanded, setIsRoleSettingsExpanded] = useState<boolean>(false);
  const [isMemberManagementExpanded, setIsMemberManagementExpanded] = useState<boolean>(false);
  ...
  // Function to toggle sub-folder visibility for Role Settings
  // const toggleRoleSettings = (event: React.MouseEvent<HTMLElement>) => {
  //   event.preventDefault();
  //   setIsRoleSettingsExpanded(!isRoleSettingsExpanded);
  //   setSelectedItem("/project_settings/project_roles/role_settings");
  //   router.push("/project_settings/project_roles/role_settings");
  // };
          ...
          <li className="mt-2">
            ...
            {isProjectSettingsExpanded && (
              <ul className="pl-8">
                ...
                <li className="mt-2">
                  <Link
                    href="/project_settings/project_roles/role_settings"
                    onClick={(e) => handleItemClick("/project_settings/project_roles/role_settings", e)}
                    className={getItemClass("/project_settings/project_roles/role_settings")}
                  >
                    <ShieldCheckIcon className="size-6" />
                    {!isCollapsed && (
                      <p className="ml-2">{t.translations.ROLES}</p>
