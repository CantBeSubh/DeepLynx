...
// import "../../globals.css";
// import SignIn from "@/app/(home)/components/SignIn";
...
export default async function Login() {
    ...
    return (<p>Welcome </p>
        ...
        //                 <h2 className="text-sm text-center text-slate-800">Username</h2>
        ...
        //                     <input type="checkbox" defaultChecked={isChecked} onChange={e => setChecked(e.target.checked)} className="checkbox w-6 h-6 appearance-none border-1 border-black rounded-md ml-9" />
        //                     keep me signed in
        //                 </label>
        ...
        //                     {/* <button className="button w-70 py-4 mx-5 text-sm text-center text-gray-50 bg-gray-700 border-2 border-black rounded-xl"> */}
        //                     {/* <SignIn /> */}
        ...
        //         </div>
        //     </main>
        //     <Link className="text-white hover:bg-[#383838] dark:hover:bg-[#ccc]" href="/"> <u>Trouble Logging in?</u></Link>
        //     <footer className="flex flex-wrap items-center justify-center gap-8 mt-16 mb-8">
        //         {links.filter((link: LinkT) => link.text.toLowerCase().includes('about') || link.text.toLowerCase().includes('contact'))
        //             .map((link: LinkT, i: number) => <ArrowButton key={i} text={link.text} href={link.href} />
        //             )}
        //     </footer>
        // </div>
    )
