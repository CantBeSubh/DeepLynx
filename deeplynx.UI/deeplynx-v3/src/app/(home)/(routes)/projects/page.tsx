...
const Projects = () => {
  ...
  const columns = [
    {
      header: "Project Name",
      data: (row: { name: any }) => row.name,
    },
    {
      header: "Description",
      data: (row: { description: any }) => row.description,
    },
    {
      header: "Last Viewed",
      data: (row: { lastViewed: any }) => row.lastViewed,
    },
  ];
  ...
  return (
    <div className="bg-base-100">
      ...
      <div className="flex w-full">
                ...
                <div className="grid grid-cols-3 gap-4 mt-4">
                  ...
                  <div className="stat flex items-center">
                    ...
                    <div>
                      ...
                      <div className="stat-value text-secondary">1,250</div>
                    </div>
                  </div>
                </div>
        ...
        <div className="md:block w-1/3">Autumn's Widgets go here 👇</div>
      </div>
