...
BEGIN
    ...
    CREATE TABLE deeplynx.project_members (
        ...
        CONSTRAINT project_members_group_id_fkey FOREIGN KEY (group_id) REFERENCES deeplynx.groups (id) ON DELETE CASCADE,
        CONSTRAINT project_members_project_id_fkey FOREIGN KEY (project_id) REFERENCES deeplynx.projects (id) ON DELETE CASCADE,
        CONSTRAINT project_members_role_id_fkey FOREIGN KEY (role_id) REFERENCES deeplynx.roles (id) ON DELETE CASCADE,
        CONSTRAINT project_members_user_id_fkey FOREIGN KEY (user_id) REFERENCES deeplynx.users (id) ON DELETE CASCADE
    );
    END IF;
END $EF$;
