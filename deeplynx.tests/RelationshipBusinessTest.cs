...
//             };
//
//             var result = await _relationshipBusiness.BulkCreateRelationships(pid, bulkDto);
//             result.Relationships.Should().HaveCount(2);
//             result.Relationships.Should().OnlyContain(r => r.Id > 0);
//             result.Relationships.Should().OnlyContain(r => r.CreatedAt >= now);
//             result.Relationships.First().Name.Should().Be("Bulk Relationship 1");
//             result.Relationships.Last().Name.Should().Be("Bulk Relationship 2");
//         }
//
//         [Fact]
