...
{
    public class KuzuDatabaseManagerTestsNoDocker
    {
        ...
        public KuzuDatabaseManagerTestsNoDocker()
        {
...
//             string tenantId = "g87gh7hij";

//             if (enableKuzu)
//             {
//                 _kuzuDatabaseManager = new KuzuDatabaseManager(_configuration, tenantId);
//             }
//             else
//             {
//                 _kuzuDatabaseManager = null;
...
//                     // Act
//                     var result = await _kuzuDatabaseManager.ExecuteKuzuQueryAsync(requestDto);
