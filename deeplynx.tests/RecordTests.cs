...
public sealed class RecordTests : IClassFixture<IntegrationTestBase>
{
    private readonly IntegrationTestBase _fixture;

    public RecordTests(IntegrationTestBase fixture)
    {
        _fixture = fixture;
    }
    ...
    //     };
    //
    //     var result = await _fixture.recordBusiness.CreateRecord(_fixture.pid, _fixture.dsid, dto);
    //     Assert.Equal(_fixture.pid, result.ProjectId);
    //     Assert.Equal(_fixture.dsid, result.DataSourceId);
    // }
    ...
    //         () => _fixture.RecordBusiness.CreateRecord(_fixture.pid, _fixture.dsid, dto));
    // }
