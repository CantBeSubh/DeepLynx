...
{
    Task<IEnumerable<EdgeResponseDto>> GetAllEdges(long projectId, long? dataSourceId, bool hideArchived);
    Task<EdgeResponseDto> GetEdge(long? edgeId, long? originId, long? destinationId, bool hideArchived);
