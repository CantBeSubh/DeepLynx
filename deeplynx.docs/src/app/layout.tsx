    ...
    logo={
      <>
        <svg width="24" height="24" viewBox="0 0 24 24">
          <path
            fill="currentColor"
            d="M12 2L15 5L20 4L22 8L19 12L22 16L20 20L15 19L12 22L9 19L4 20L2 16L5 12L2 8L4 4L9 5Z" 
...
const basePath = process.env.NEXT_PUBLIC_DOCS_PATH ? `${process.env.NEXT_PUBLIC_DOCS_PATH}` : ""
    ...
    >
      ...
      <body>
        <Layout
          ...
          docsRepositoryBase="https://github.com/idaholab/Deep-Lynx"
          footer={footer}
