...
For example, if you have a folder called `overview` and a file called `getting-started.mdx`, the URL will appear as `example.com/docs/overview/getting-started`. As such, everything should follow a URL naming scheme: lowercase, alphanumeric, and hyphenated.