...
Work with your Nexus system administrator to register your application. **NOTE: If you are on a local development instance of Nexus, you can make yourself the SysAdmin by setting the `SUPERUSER_EMAIL` environment variable to your registered okta email address.**
...
## Step 3: Extract Code and State from the Callback Endpoint
...
def exchange_code_for_token(code, state):
    token_url = 'https://nexus.example.com/api/oauth/exchange'
...
def get_data():
    ...
    response = requests.get(
        'https://nexus.example.com/api/projects/GetAllProjects',
