...
public class SensitivityLabelBusiness : ISensitivityLabelBusiness
{
       ...
       long currentUserId, CreateSensitivityLabelRequestDto dto, long? projectId, long? organizationId)
    {
        ...
        if (projectId.HasValue)
        {        
            await _eventBusiness.CreateEvent(currentUserId, eventLog, null, projectId);
        }
        else
        {
            await _eventBusiness.CreateEvent(currentUserId, eventLog, organizationId, null);
        }
        ...
        long currentUserId, long labelId, UpdateSensitivityLabelRequestDto dto)
    {
        ...
        {        
            await _eventBusiness.CreateEvent(currentUserId, eventLog, null, label.ProjectId);
        }
        else
        {
            await _eventBusiness.CreateEvent(currentUserId, eventLog, label.OrganizationId, null);
        }
