...
namespace deeplynx.api.Controllers
{
    ...
    public class PermissionController : ControllerBase
    {
            ...
            [FromQuery] bool hideArchived = true)
        {
            ...
            {
                var permissions =
                    await _permissionBusiness.GetAllPermissions(labelId, null, organizationId, hideArchived);//setting project ID null for now to circumvent xor logic
            ...
            [FromBody] CreatePermissionRequestDto dto)
        {
            try
            {
                ...
                var permission =
                    await _permissionBusiness.CreatePermission(currentUserId, dto, null, organizationId);//setting project ID null for now to circumvent xor logic
                return Ok(permission);
            }
            catch (Exception exc)
            {
