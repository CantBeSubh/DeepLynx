...
public class EventController : ControllerBase // Inherit from ControllerBase
{
    ...
    /// <param name="organizationId">Optional filter to only include events matching the organizationId</param>
    /// <returns></returns>
    ...
    /// <returns></returns>
    [HttpGet("{projectId}/GetAllEventsByUserProjectSubscriptions",
        Name = "api_get_all_events_by_user_project_subscriptions")]
